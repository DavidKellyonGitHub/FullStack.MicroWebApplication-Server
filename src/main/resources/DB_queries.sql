CREATE TABLE IF NOT EXISTS blogs (
                                     ...
                                     blog_like_count numeric(20) NOT NULL DEFAULT '0',
...
Insert into blogs (blog_id, blog_date, blog_title, blog_content, blog_tag, blog_status, blog_like_count, blog_comment_count)
Values (103 ,date '2015-04-09' + time '13:45:03', 'SCENE III. A room in the palace.',
        'ROSALIND and more text', 'Scene 3', 'posted', 43, 2);
...
Values (1001 ,102,'Rosalind', 'rosalid@gmail.com',
        date '2015-04-09' + time '13:45:03', 43, 2);

Insert into likes (like_ID, like_type, like_comment_ID)
Values (10001 ,'LIKE', 1001);
