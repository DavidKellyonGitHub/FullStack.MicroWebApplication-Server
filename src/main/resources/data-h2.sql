...
Values (1 ,date '2020-04-15' + time '13:00:00', 'Trump says US has ‘passed the peak’ of coronavirus outbreak!',
...
Insert into blog_post (blog_id, date_created, title, body, tag, status)
Values (2 ,date '2020-04-16' + time '13:00:00', 'Some stimulus checks are being sent to the wrong accounts: ''The bank account number is not even close.''',
